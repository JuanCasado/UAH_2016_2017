...
public class LogIn extends javax.swing.JFrame {
    ...
    private void ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonActionPerformed
        if(nif.getText().equals("admin") && pass.getText().equals("admin"))
        {
           Admin a = new Admin();
           a.setVisible(true);
        ...
        else if(nif.getText().equals("Crupier"))
        {
            Warnning w = new Warnning();
            w.setTextoW("Contraseña incorrecta");
            w.setVisible(true);
        }
        else if (CasaDeApuestas.registrado(nif.getText(), pass.getText()))
        {
            NIFin=nif.getText();
            Dentro d = new Dentro();
            d.setVisible(true);
    ...
    /**
     * Cierra el JFrame y abre el de BlackJack
     */
