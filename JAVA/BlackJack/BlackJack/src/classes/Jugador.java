...
public abstract class Jugador implements Serializable
{
    ...
    /**
     * Permite al jugador retirar los bneficios de su cuenta en el juego
     * @param dinero 
     */
    public abstract void retirarBeneficios(double dinero);

    /**
     * Permite registrar lo que se pierde o se gana al jugar
     * @param dinero 
     */
    public void dineroEnPartida(double dinero)
    {
