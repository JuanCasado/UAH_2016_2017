...
public class Ex extends Exception
{
    ...
    public static final String DINERO_INSUFICIENTE="No tienes suficiente diero en la cuenta";
    public static final String DINERO_NEGATIVO="No se pueden retirar la cantidad introducida";
    public static final String BORRADO="No se puedo borrar el fichero del jugador";
